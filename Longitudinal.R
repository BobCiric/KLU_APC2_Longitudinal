...
pib_mdl <- lm(data_multiple_visit$GDS_TOTAL[which(data_multiple_visit$PiB_STATUS_CODE == TRUE)] ~ 
                data_multiple_visit$Visit_Relative[which(data_multiple_visit$PiB_STATUS_CODE == TRUE)], data = data_multiple_visit)
abline(pib_mdl, col='red')
mdl <- lm(data_multiple_visit$GDS_TOTAL[which(data_multiple_visit$PiB_STATUS_CODE == FALSE)] ~ 
            data_multiple_visit$Visit_Relative[which(data_multiple_visit$PiB_STATUS_CODE == FALSE)], data = data_multiple_visit)
abline(mdl, col='black')
points(data_multiple_visit$Visit_Relative[data_multiple_visit$PiB_STATUS_CODE == TRUE],
...
mdl_right_hippocampus_FWHM <- lm(Right_Hippocampus_FWHM ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                                +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_right_hippocampus_FWHM)

mdl_left_dlpfc_FWHM <- lm(Left_DLPFC_FWHM ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                                +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_left_dlpfc_FWHM)

mdl_right_dlpfc_FWHM <- lm(Right_DLPFC_FWHM ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                                 +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_right_dlpfc_FWHM)
#Regression Activation #######################################################################
mdl_left_hippocampus_activation <- lm(Left_Hippocampus_Activation ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                                +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_left_hippocampus_activation)

mdl_right_hippocampus_activation <- lm(Right_Hippocampus_Activation ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                                 +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_right_hippocampus_activation)

mdl_left_dlpfc_activation <- lm(Left_DLPFC_Activation ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                          +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_left_dlpfc_activation)

mdl_right_dlpfc_activation <- lm(Right_DLPFC_Activation ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                           +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_right_dlpfc_activation)

#Regression abs AI #######################################################################
mdl_abs_hippocampus_AI <- lm(Abs_Hippocampus_AI ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                                      +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_abs_hippocampus_AI)

mdl_abs_dlpfc_AI <- lm(Abs_DLPFC_AI ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                             +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_abs_dlpfc_AI)

#Regression Cognition #######################################################################
mdl_memory_learning <- lm(memory_learning ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                             +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_memory_learning)

mdl_memory_retrieval <- lm(memory_retrieval ~GDS_TOTAL+ Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                       +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_memory_retrieval)
#7.738e-05**
mdl_visuospatial <- lm(visuospatial ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                           +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
summary(mdl_visuospatial)

mdl_language <- lm(language ~ GDS_TOTAL+Visit_Relative + Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_STATUS_CODE
                       +Visit_Relative*FDG_SUVR_GTM_FS_Global+Visit_Relative*PiB_STATUS_CODE+Visit_Relative*APOE_STATUS_CODE, data = data_multiple_visit)
